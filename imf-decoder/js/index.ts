async function verifyWasmBuild() {
  try {
      ...
      console.log('🔧 IMFDecoder Methods:', Object.getOwnPropertyNames(Object.getPrototypeOf(decoder)));
...
async function runDecoderTests(decoder) {
  try {
      ...
      try {
          ...
          console.log("set_reference_data exists:", typeof decoder.set_reference_data);
          throw e;
      }
...
// Keep the page load initialization
